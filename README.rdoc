...
This applications is a bloated version of <b>find [dir1 [dir2 [...]]] -type f -exec md5sum '{}' \; | sort | uniq -w 32 -D</b>.
...
== INSTALL:
  ...
  TODO not yet, need to build a dmg file

== LICENSE:

rudups is released under the GPL v2 license.
